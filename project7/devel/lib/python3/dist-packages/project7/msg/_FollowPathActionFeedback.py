...
"""autogenerated by genpy from project7/FollowPathActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class FollowPathActionFeedback(genpy.Message):
  _md5sum = "1ace3b3e658da2ec2522e1ef08a968f9"
  _type = "project7/FollowPathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','project7/FollowPathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = project7.msg.FollowPathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = project7.msg.FollowPathFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.total_distance_to_path
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.total_distance_to_path,) = _get_struct_f().unpack(str[start:end])
      return self
