...
"""autogenerated by genpy from project7/FollowPathAction.msg. Do not edit."""
import codecs
import sys
...
class FollowPathAction(genpy.Message):
  _md5sum = "7a2f5dc96ac0068e58a65fae166e579f"
  _type = "project7/FollowPathAction"
...
"""
  ...
  _slot_types = ['project7/FollowPathActionGoal','project7/FollowPathActionResult','project7/FollowPathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = project7.msg.FollowPathActionGoal()
      if self.action_result is None:
        self.action_result = project7.msg.FollowPathActionResult()
      if self.action_feedback is None:
        self.action_feedback = project7.msg.FollowPathActionFeedback()
    else:
      self.action_goal = project7.msg.FollowPathActionGoal()
      self.action_result = project7.msg.FollowPathActionResult()
      self.action_feedback = project7.msg.FollowPathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_result.result.total_elapsed_time, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.total_distance_to_path
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.total_elapsed_time, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.total_distance_to_path,) = _get_struct_f().unpack(str[start:end])
      return self
