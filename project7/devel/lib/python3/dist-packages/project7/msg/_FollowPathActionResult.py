...
"""autogenerated by genpy from project7/FollowPathActionResult.msg. Do not edit."""
import codecs
import sys
...
class FollowPathActionResult(genpy.Message):
  _md5sum = "59791326ddc52e63e1df77429fefff88"
  _type = "project7/FollowPathActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','project7/FollowPathResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = project7.msg.FollowPathResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = project7.msg.FollowPathResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.total_elapsed_time
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_elapsed_time,) = _get_struct_f().unpack(str[start:end])
      return self
